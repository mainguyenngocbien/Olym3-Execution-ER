...
# Fix Simple Service - Stable Erigon Configuration
# This script will create a simple, stable service configuration

set -e

echo "🔧 Fixing Simple Service - Stable Configuration"
...
print_header "Creating Simple Service File"
...
print_status "Simple service file created"

print_header "Testing Direct Erigon Command"
cd /root/erigon

print_status "Testing with minimal configuration..."
timeout 15s ./erigon --datadir=/root/erigon_data --chain=olym3-testnet-s3 --http --http.addr=0.0.0.0 --http.port=8545 --http.api=engine,eth,net,web3 --port=30303 --log.console.verbosity=3 || echo "Command completed or timed out"
