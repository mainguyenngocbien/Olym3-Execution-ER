...
# Olym3 Testnet Season 3 - Working Setup with Chain ID 256000
# Author: Olym3 Labs DevOps Team

set -e

echo "🚀 Olym3 Testnet Season 3 - Working Setup (Chain ID: 256000)"
...
print_header "Creating Fixed Service File"
...
print_status "Service file created (fixed -ws.addr issue)"
