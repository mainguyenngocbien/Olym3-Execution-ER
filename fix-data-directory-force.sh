...
# Fix Data Directory Force - Force Custom Data Directory
# This script will force Erigon to use our custom data directory

set -e

echo "🔧 Fix Data Directory Force - Force Custom Directory"
...
print_header "Creating Symlink to Force Custom Directory"
mkdir -p /root/.local/share
ln -sf /root/erigon_data /root/.local/share/erigon

print_header "Creating Force Service File"
...
print_status "Force service file created"
...
print_header "Creating Force Status Script"
...
print_header "Creating Force Configuration Summary"
cat > /root/olym3-summary.txt << EOF
=== Olym3 Testnet Season 3 Force Configuration ===
...
Force Configuration:
- Symlink: /root/.local/share/erigon -> /root/erigon_data
- Environment: ERIGON_DATADIR=/root/erigon_data
- Environment: XDG_DATA_HOME=/root/erigon_data
