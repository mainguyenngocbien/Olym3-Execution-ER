...
# Olym3 Testnet Season 3 - Final Setup with Chain ID 256000
# Author: Olym3 Labs DevOps Team

set -e

echo "🚀 Olym3 Testnet Season 3 - Final Setup (Chain ID: 256000)"
...
print_header "Creating Genesis File for Chain ID 256000"
